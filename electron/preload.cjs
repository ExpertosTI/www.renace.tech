...
try {
  contextBridge.exposeInMainWorld('renaceDesktop', {
    ...
    listCupsPrinters: () => ipcRenderer.invoke('renace:pos-list-printers'),
    setPosSettings: (cfg) => ipcRenderer.invoke('renace:pos-set-settings', cfg),
    testPosPrint: () => ipcRenderer.invoke('renace:pos-test-print'),
    testPosCashbox: () => ipcRenderer.invoke('renace:pos-test-cashbox'),
